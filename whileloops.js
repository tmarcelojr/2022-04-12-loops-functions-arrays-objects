...
// Task: while loop - between 0 and 20, numbers that are divisible by 2, it should be multiplied by 3 and printed. All other integers should not be printed
while(i < 20) {
    console.log('condition', i % 2)
    if(i % 2 === 0) {
        console.log('met condition', i * 3)
    }
    // console.log(i)
    i++
}
